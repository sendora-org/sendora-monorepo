...
contract MerkleMultiSend {
    ...
    function execute(
        ...
        // validate
        _validate(merkle, batchID, token, referrer, recipients, amounts);
    ...
    function _validate(
        ...
        bytes32 executeID = keccak256(
            abi.encode(batchID, merkle.merkleRoot, merkle.proof)
        );
        ...
        require(
            MerkleProof.verify(merkle.proof, merkle.merkleRoot, leaf),
