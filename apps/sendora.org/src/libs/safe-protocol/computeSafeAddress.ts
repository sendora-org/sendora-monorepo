...
export const addModulesLibAddress = '0x8EcD4ec46D4D2a6B64fE960B3D64e8B94B2234eb';
...
export const getSafeAddress = (EOASignerAddress: Hex[], safeConfig: any) => {
	const initializer = computeInitializer(
		EOASignerAddress,
		safeConfig
	);
	return computeSafeAddress(safeConfig.factoryAddress, safeConfig.masterCopy, initializer,safeConfig.masterCopyBytecode);
};