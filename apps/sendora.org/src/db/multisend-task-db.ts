...
export class MultisendTaskDB extends Dexie {
    ...
    constructor() {
        ...
        this.version(1).stores({
            ...
            multisendTaskItems: '[batch_id+position],[batch_id+status],[batch_id+status+updated_at],batch_id,position,tx_status,tx_confirmed_at,tx_sent_at,status,created_at,updated_at'
        });
